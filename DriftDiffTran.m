...
%Simulation = 'carrierTransPA';
% Simulation = 'PNJctEqBias';

 Simulation = 'PNJctEqBiaslinear';
...
elseif strcmp(Simulation,'carrierTransPA')
   eval('carrierTansPA');
   elseif strcmp(Simulation,'PNJctEqBiaslinear')
    eval('Linear_junction');
end
